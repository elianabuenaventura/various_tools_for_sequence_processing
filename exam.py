...
longest3 = list(orfs3)
for i in range(len(longest3)):
    if longest3[i] is max_len(orfs3):
      print ("position: %d" % (i, i))

longest3 = list(orfs3)
for i in longest3:
    if i is max_len(orfs3):
        this = True
...
# TGCGCGC , AATGGCA , CGCGCCG , CATCGCC
reps = ["TGCGCGC", "AATGGCA", "CGCGCCG", "CATCGCC"]
repeat_occurrences = []
print(" ")
for repeat in reps:
    occurences = 0
